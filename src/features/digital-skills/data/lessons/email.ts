...
export const emailLessons = [
  createDigitalSkillsLesson({
    ...
    whyItMatters:
      'Email is how schools, banks, and services send important information. Gmail is free and widely used.',
    difficulty: 'gentle',
    estimatedMinutes: 10,
    learningObjective:
      'You will open Gmail, read one message, and find where to write a new email.',
    steps: [
      {
        instruction: 'Go to mail.google.com and sign in with your Google account.',
        detail:
          'Use your email address and password. If you share a computer, sign out when finished.',
      },
      {
    ...
    practicalTask:
      'Open Gmail, read one email, and open the Compose window (you do not have to send yet).',
  ...
  createDigitalSkillsLesson({
    ...
    whyItMatters:
      'Sending your own email lets you reach teachers, family, and services without waiting on someone else.',
    difficulty: 'gentle',
    estimatedMinutes: 12,
    ...
    steps: [
      ...
      },
      {
        ...
        detail:
          'Use their full email address. One person is enough for your first try.',
      },
      {
        instruction: 'Add a short subject line.',
        detail:
          'Example: "Hello from me" or "Question about school form". Helps them know what the email is about.',
      },
      {
    ...
    practicalTask:
      'Send a friendly note to your own email or a family member who agreed to receive it.',
  ...
  createDigitalSkillsLesson({
    ...
    whyItMatters:
      'Attachments let you send homework photos, PDFs, and forms without printing.',
    difficulty: 'moderate',
    estimatedMinutes: 10,
    learningObjective:
      'You will attach one small file and see its name before sending.',
    steps: [
      {
      ...
      },
      {
        ...
        detail:
          'You should see the file name under the message. Large files may fail — photos under 10 MB are usually fine.',
      },
      {
    ...
    practicalTask:
      'Attach one practice file to a draft email (send only if appropriate).',
  ...
  createDigitalSkillsLesson({
    ...
    whyItMatters:
      'School and office mail often send PDFs you must save and print or upload elsewhere.',
    difficulty: 'moderate',
    estimatedMinutes: 9,
    ...
    steps: [
      ...
      },
      {
        ...
        detail:
          'File Explorer → Downloads → drag the file to "Her Growth practice" or Documents.',
      },
      {
    ...
    practicalTask:
      'Download one attachment you already received (or from your own sent mail) and file it in a folder.',
