...
export const internetLessons = [
  createDigitalSkillsLesson({
    ...
    whyItMatters: 'The browser is your door to the internet — news, forms, and learning all start here.',
    difficulty: 'gentle',
    estimatedMinutes: 8,
    learningObjective: 'You will open your browser and visit one safe website you trust.',
    steps: [
      {
        instruction: 'Click the browser icon on the taskbar or desktop.',
        detail: 'Common names: Chrome, Microsoft Edge, Firefox. Only one needs to open.',
      },
      {
      ...
      },
      {
        ...
        detail: 'Example: your bank only if you already use it, or a familiar news site. Avoid random links from messages.',
      },
      {
        instruction: 'Use the refresh button if the page looks stuck.',
        detail: 'The circular arrow reloads the page. Wait a few seconds before clicking again.',
      },
    ],
  ...
  createDigitalSkillsLesson({
    ...
    difficulty: 'gentle',
    estimatedMinutes: 8,
    learningObjective: 'You will run one search and open a result that matches what you needed.',
    steps: [
      {
      ...
      },
      {
        ...
        detail: 'Example: "how to save photo on Android phone" instead of one vague word.',
      },
      {
        instruction: 'Press Enter and scan the titles before clicking.',
        detail: 'Look for official sites (.gov, school sites, or brands you recognize).',
      },
      {
        instruction: 'Open one result in a new tab (optional).',
        detail: 'Right-click a link → Open link in new tab — so you can go back to results easily.',
      },
    ],
    practicalTask: 'Search for a recipe or school topic you care about and open one helpful page.',
  ...
  createDigitalSkillsLesson({
    ...
    whyItMatters: 'Tabs let you keep several pages open — like bookmarks on a desk — without closing the browser.',
    difficulty: 'gentle',
    estimatedMinutes: 7,
    ...
    steps: [
      ...
      },
      {
        ...
        detail: 'Right-click the tab bar → Reopen closed tab, or use Ctrl+Shift+T on Windows.',
      },
    ],
    practicalTask: 'Keep two tabs open for five minutes, then close the one you no longer need.',
  ...
  createDigitalSkillsLesson({
    ...
    whyItMatters: 'Downloads bring PDFs, forms, and photos to your device — knowing where they land prevents panic later.',
    difficulty: 'moderate',
    estimatedMinutes: 10,
    learningObjective: 'You will download a file from a trusted site and open it from Downloads.',
    steps: [
      {
        instruction: 'Download only from sites you trust.',
        detail: 'School portals, government sites, or stores you already use are safer than random pop-ups.',
      },
      {
      ...
      },
      {
        ...
        detail: 'File Explorer → Downloads, or click the downloaded file name in the browser bar.',
      },
      {
        instruction: 'Scan with your eyes: does the file name match what you expected?',
        detail: 'If the name looks strange, do not open it — delete it and ask for help.',
      },
    ],
    practicalTask: 'Download one file you need (form, photo, or PDF) and open it from Downloads.',
  ...
  createDigitalSkillsLesson({
    ...
    whyItMatters: 'Many school and government forms need you to upload ID scans or homework files.',
    difficulty: 'moderate',
    estimatedMinutes: 10,
    learningObjective: 'You will choose a file from your computer in an upload dialog (practice site or form).',
    steps: [
      {
    ...
    practicalTask: 'Practice uploading a harmless text file to a form you are allowed to test (or a draft email attachment).',
    completionAction: 'I selected a file using Choose file and saw its name on the form.',
  }),
  createDigitalSkillsLesson({
    ...
    whyItMatters: 'Most small glitches fix themselves with a pause, refresh, or router check — no need to feel stuck.',
    difficulty: 'moderate',
    estimatedMinutes: 9,
    ...
    steps: [
      {
        ...
        detail: 'If nothing works, the Wi‑Fi router may need a restart — ask someone who manages it if unsure.',
      },
      {
        instruction: 'Turn Wi‑Fi off and on on your device, or unplug and replug the router after asking.',
    ...
    practicalTask: 'Practice the three steps on a slow page (refresh, wait, try again).',
